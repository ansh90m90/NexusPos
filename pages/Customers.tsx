            ...
            footer={
                <div className="flex justify-between items-center w-full">
                    ...
                    <div className="flex gap-4">
                        ...
                        <button type="submit" form="customer-form" className="px-4 py-2 rounded-lg bg-primary-500 text-white hover:bg-primary-600 transition-colors shadow-sm">Save</button>
                    </div>
                </div>
            }
        >
            <form id="customer-form" onSubmit={handleSubmit} className="space-y-4">
                <input name="name" value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })} placeholder="Customer's Full Name" className="w-full p-2 border rounded bg-theme-main text-theme-main border-theme-main focus:ring-1 focus:ring-primary-500" required />
                <input name="phone" value={formData.phone} onChange={e => setFormData({ ...formData, phone: e.target.value })} placeholder="Customer's Phone (for receipts)" className="w-full p-2 border rounded bg-theme-main text-theme-main border-theme-main focus:ring-1 focus:ring-primary-500" />
                <input name="address" value={formData.address} onChange={e => setFormData({ ...formData, address: e.target.value })} placeholder="Customer's Address (optional)" className="w-full p-2 border rounded bg-theme-main text-theme-main border-theme-main focus:ring-1 focus:ring-primary-500" />
                <select name="tier" value={formData.tier} onChange={e => setFormData({ ...formData, tier: e.target.value as 'Retail' | 'Wholesale' })} className="w-full p-2 border rounded bg-theme-main text-theme-main border-theme-main">
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-[70] p-4 modal-content">
            <form onSubmit={handleSubmit} className="bg-theme-surface rounded-lg shadow-xl p-6 max-w-sm w-full border border-theme-main">
                ...
                <p className="text-theme-muted mb-4">For: <span className="font-semibold text-theme-main">{customer.name}</span></p>
                ...
                {appSettings.upiId && paymentAmount > 0 && (
                    <div className="flex flex-col items-center justify-center p-4 bg-theme-main rounded-xl border border-theme-main mb-4">
                        <p className="text-sm font-bold text-theme-muted mb-2">Scan to Pay via UPI</p>
                ...
                <label htmlFor="payment" className="block text-sm font-medium mb-1 text-theme-main">Enter Amount Received</label>
                ...
                <p className="text-xs text-theme-muted mt-1">Current Balance: ₹{customer.creditBalance.toFixed(2)}</p>
